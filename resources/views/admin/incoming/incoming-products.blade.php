...
<div class="max-w-7xl mx-auto" x-data="{ 
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
        <div class="shrink-0">
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Manajemen Barang Masuk</h1>
            <p class="text-sm text-gray-500 font-light">Kelola stok dan inventaris barang masuk di SiGudang.</p>
        </div>
        ...
        <div class="w-full md:w-auto flex items-center gap-4">
            ...
            <a href="{{ route('incoming-products.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-all text-sm font-bold shadow-sm">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50/50 border-b border-gray-100">
                        ...
                        <th class="px-6 py-4 text-[11px] uppercase tracking-widest font-bold text-gray-400">Deskripsi</th>
